                ...
                <div class="col-auto">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-auto mt-0" wire:ignore>
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <select multiple  wire:model="created_by" class="form-control select-md bg-white"
                                    wire:change="CollectedBy($event.target.value)" id="created_by">
                        ...
                        <div class="col-auto mt-3">
                                ...
                                class="btn btn-outline-danger select-md mt-3">Clear</a>
                        </div>
                        <div class="col-auto">
                            <a href="javscript:void(0)" wire:click="export" class="btn btn-outline-success select-md mt-3"><i
